...
For a list of available icon names, please refer to the icons list ([https://demos.telerik.com/kendo-ui/web/styling/icons.html](https://www.telerik.com/design-system/docs/foundation/iconography/icon-list/)).
